...
<body>
    ...
    <form action="/register" method="post" class="login-form mt-[40px] mx-auto w-4/5 max-w-md p-5">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="name" class="bg-slate-50 border border-gray-200 text-gray-900 text-sm rounded-sm focus:border-blue-500 block w-full p-2.5 " placeholder="Enter your name" required />
        </div> 
